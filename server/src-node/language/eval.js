...
async function evalIsGermanDumb(context, text) {
	...
	// if (ratioOfDefiniteGermanWords < 0.12) {
	// 	console.log(words)
	// 	console.log(germanWords, 'of', totalWords, 'are german')
	// }
	return ratioOfDefiniteGermanWords > 0.12
}


// const sentence = "Das ist ein Beispiel mit UmläutÖn: äöüß.";
// const words = sentence.match(/[\wäüöß]+/gi);
// console.log(words);
